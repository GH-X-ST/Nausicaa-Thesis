...
This repository publishes the crawlable thesis landing page for Google Scholar-style indexing. The canonical metadata page is <https://gh-x-st.github.io/Nausicaa-Thesis/>, with a minimal publications page at <https://gh-x-st.github.io/Nausicaa-Thesis/publications.html>.

The Scholar-compatible thesis PDF is available directly at <https://gh-x-st.github.io/Nausicaa-Thesis/Viability-Guided%20Sim-to-Real%20Transfer%20for%20a%20Small%20Fixed-Wing%20Glider%20in%20Uncertain%20Indoor%20Updrafts.pdf> (4.5 MB). A full-quality PDF remains available through the workflow repository for human readers.
